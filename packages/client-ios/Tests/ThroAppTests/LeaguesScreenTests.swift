...
final class LeaguesScreenTests: XCTestCase {
    ...
    func testEveryLineSaysWhereItCameFrom() throws {
        ...
        XCTAssertEqual(LeaguesPlot.provenance(l),
                       "From LeagueRepublic (read 10 Sep 2026). Venues are matched from OpenStreetMap (© OpenStreetMap contributors), most by the team's name; whoever runs a team sets its pub on the team's page.",
