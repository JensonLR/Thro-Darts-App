...
public object Contract {
    ...
    public val endpoints: List<Endpoint> = listOf(
        ...
        Endpoint(
            ...
            responses = mapOf(200 to "challengeId and publicKey creation options", 400 to "malformed", 503 to "passkeys are not configured on this server"),
        ),
        Endpoint(
            ...
            responses = mapOf(200 to sessionResponse, 400 to "malformed", 401 to "the registration does not verify, and why", 503 to "passkeys are not configured on this server"),
        ),
        Endpoint(
            ...
            responses = mapOf(200 to "challengeId and publicKey request options", 400 to "malformed", 503 to "passkeys are not configured on this server"),
        ),
        Endpoint(
            ...
            responses = mapOf(200 to sessionResponse, 400 to "malformed", 401 to "the assertion does not verify, and why", 503 to "passkeys are not configured on this server"),
        ),
        Endpoint(
