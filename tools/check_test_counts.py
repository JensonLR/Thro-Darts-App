...
ROWS = {
    ...
    "| The opening, the app shell and the team screens |": ["packages/client-ios/Tests/ThroAppTests"],
    ...
    "| Scoring and the notice on Android |": ["packages/client-android/src/test"],
}
...
ANCHORED = [
    ...
    ("docs/runbooks/CLIENT_IOS.md", r"(\d+) opening, app and teams", [f"{IOS}/ThroAppTests"]),
    ...
    ("docs/runbooks/CLIENT_IOS.md", r"(\d+) on the device's book of teams and people",
