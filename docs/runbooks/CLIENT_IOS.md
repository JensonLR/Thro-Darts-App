...
> 904 tests in all: 188 design, 105 journal, 105 scoring session and share card, 426 opening, app and teams, 25 Lock Screen, wall and widgets, 29 on a wrist, 26 on a wall — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 188 design tests on macOS, every push |
