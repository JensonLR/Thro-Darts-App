...
> 278 tests in all: 38 design, 89 journal, 45 scoring session, 106 opening, app and clubs — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 38 design tests on macOS, every push |
