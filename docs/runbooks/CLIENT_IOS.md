...
> 734 tests in all: 169 design, 105 journal, 101 scoring session and share card, 334 opening, app and teams, 25 Lock Screen, wall and widgets — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 169 design tests on macOS, every push |
