...
> 870 tests in all: 184 design, 105 journal, 105 scoring session and share card, 396 opening, app and teams, 25 Lock Screen, wall and widgets, 29 on a wrist, 26 on a wall — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 184 design tests on macOS, every push |
