...
> 465 tests in all: 108 design, 91 journal, 61 scoring session and share card, 180 opening, app and clubs, 25 Lock Screen, wall and widgets — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 108 design tests on macOS, every push |
