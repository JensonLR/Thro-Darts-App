...
> 618 tests in all: 162 design, 105 journal, 99 scoring session and share card, 227 opening, app and teams, 25 Lock Screen, wall and widgets — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 162 design tests on macOS, every push |
