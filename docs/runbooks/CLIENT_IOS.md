...
> 755 tests in all: 178 design, 105 journal, 101 scoring session and share card, 346 opening, app and teams, 25 Lock Screen, wall and widgets — and the
...
| `packages/client-ios` → `ThroDesign` | the approved components as SwiftUI | 178 design tests on macOS, every push |
