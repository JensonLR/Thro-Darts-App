...
The app draws the wordmark live (LaunchSequence.swift, WordmarkGeometry) with these same proportions;
this script is the reference rendering of them, not an asset the app ships.
"""
import math, os, sys
