...
| Clubs, leagues and tournaments | 8 tests — the whole authority table rather than examples of it; that a member recorded as a minor is listed to an admin and to nobody else; that no accent a club can pick makes the app unreadable, proved by sweeping the colour cube; that an announcement reaches nobody whose age is minor **or unknown** until OD-010 is answered; and that a fixture may be moved but never asserts a result |
